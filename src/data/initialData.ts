...
export const INITIAL_IOS: InsertionOrder[] = [
  {
    io_id: 'IO-2026-001',
    organizationId: 'org-adapundi',
    contract_id: 'CTR-001',
...
export const INITIAL_INSERTION_ORDERS = INITIAL_IOS;
...
export const INITIAL_SPENDINGS: PartnerSpending[] = [
  {
    id: 'SPD-001',
    organizationId: 'org-adapundi',
    vendor_id: 'PRT-001',
