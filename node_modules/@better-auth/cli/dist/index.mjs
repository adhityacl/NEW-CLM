...
async function main() {
	...
	try {
		const betterAuthPkg = createRequire(process.cwd() + "/")("better-auth/package.json");
		if (betterAuthPkg.version && semver.gte(betterAuthPkg.version, "1.5.0")) console.warn(chalk.yellow(`\nWarning: You are using @better-auth/cli (v${cliVersion}) with better-auth v${betterAuthPkg.version}.\nThe old CLI may produce unexpected results with better-auth v1.5.x or later.\nPlease use the new CLI instead: `) + chalk.cyan("npx auth@latest") + "\n");
	} catch {}
